...
按 [README_Qclaw.md](README_Qclaw.md) 或 [README_Hermes.md](README_Hermes.md) 中的渠道步骤，将三件套同步到对应环境（具体路径与写入方式以各渠道文档为准）。
...
| 展示名              | 路径                                        |
| ---------------- | ----------------------------------------- |
| 搜索引擎             | [skills/search-engine/](skills/search-engine/)                   |
| 竞品调研             | [skills/competitor-research/](skills/competitor-research/)             |
| PRD 文档生成器        | [skills/prd-document-generator/](skills/prd-document-generator/)          |
| 业务流程图生成器         | [skills/business-diagram-generator/](skills/business-diagram-generator/)      |
| 交互原型生成器          | [skills/interactive-prototype-generator/](skills/interactive-prototype-generator/) |
| PRD 逻辑检测         | [skills/logic-detector/](skills/logic-detector/)                  |
| 问题追踪器            | [skills/issue-tracker/](skills/issue-tracker/)                   |
| 报告生成器            | [skills/report-generator/](skills/report-generator/)                |
| 飞书需求录入 / 看板 / 归档 | [skills/feishu-requirement-entry/](skills/feishu-requirement-entry/) 等      |
| 竞品网页抓取器          | [skills/competitor-web-crawler/](skills/competitor-web-crawler/)          |
| 竞品差异面板           | [skills/difference-panel/](skills/difference-panel/)                |
| 应用市场舆情 insight   | [skills/app-market-sentiment/](skills/app-market-sentiment/)            |
| 核心业务指标分析         | [skills/core-metrics-analysis/](skills/core-metrics-analysis/)           |
| 用户反馈结构化          | [skills/user-feedback-processor/](skills/user-feedback-processor/)         |
| 主动预警             | [skills/alert-early-warning/](skills/alert-early-warning/)             |
| 数据可视化            | [skills/data-visualization/](skills/data-visualization/)              |
...
人设与技能边界以 [product-agent/](product-agent/) 与 [skills/](skills/) 下各子目录的 `SKILL.md` 为准。